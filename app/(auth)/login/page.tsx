    ...
    <div className="relative min-h-screen overflow-hidden lg:grid lg:grid-cols-[1.1fr_minmax(420px,0.9fr)]">
      ...
      <section className="relative hidden flex-col justify-between overflow-hidden border-r border-border px-12 py-12 lg:flex">
        ...
        <div className="relative max-w-[440px]">
          <h1 className="display text-[38px] leading-[1.12]">Discounts that route their own approvals.</h1>
          ...
          <dl className="mt-9 grid grid-cols-3 gap-6 border-t border-border pt-6">
            <div>
              <dt className="text-[12px] text-muted">Routing</dt>
              <dd className="mt-1 text-[14px] text-text-dim">By blended risk</dd>
            </div>
            <div>
              <dt className="text-[12px] text-muted">Fulfilment</dt>
              <dd className="mt-1 text-[14px] text-text-dim">Split across warehouses</dd>
            </div>
            <div>
              <dt className="text-[12px] text-muted">Billing</dt>
              <dd className="mt-1 text-[14px] text-text-dim">One-time and recurring</dd>
            </div>
          </dl>
        </div>
